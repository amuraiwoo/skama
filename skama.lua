-- 重複削除
local old = game:GetService("CoreGui"):FindFirstChild("XenoSlowReal")
if old then old:Destroy() end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "XenoSlowReal"
...
Bar.BackgroundColor3 = Color3.fromRGB(0, 255, 180) -- エメラルドグリーン
...
PercentLabel.Position = UDim2.new(0.5, 0, 0.85, 0)
...
task.spawn(function()
    ...
    for i = 0, 100 do
        ...
        -- 次の更新までの待ち時間をランダムにして「リアルさ」を出す
        -- 基本は0.3秒、たまに1秒止まったりする
        local baseWait = 0.25
        if i == 24 or i == 78 or i == 92 then
            StatusLabel.Text = "DECRYPTING FILES..."
            baseWait = 1.2 -- 特定の場所でわざと長く止める
        elseif i == 50 then
        ...
        -- バーをヌルヌル動かす
        TweenService:Create(Bar, TweenInfo.new(baseWait, Enum.EasingStyle.Linear), {
